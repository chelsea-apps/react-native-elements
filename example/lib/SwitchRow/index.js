...
style, labelStyle, labelActiveColor, labelDefaultColor, trackActiveColor, trackDefaultColor, thumbColor, thumbActiveColor, toggleOnSwitchIconPressOnly = false, }) => {
    return (React.createElement(TouchableOpacity, { style: [styles.container, style], onPress: () => setActive(!active), activeOpacity: 1, disabled: toggleOnSwitchIconPressOnly },
