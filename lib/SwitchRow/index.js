...
// Styling
style, labelStyle, labelActiveColor, labelDefaultColor, trackActiveColor, trackDefaultColor, thumbColor, }) => {
    return (React.createElement(TouchableOpacity, { style: [styles.container, style], onPress: () => setActive(!active), activeOpacity: 1 },
        ...
        React.createElement(Switch, { trackColor: {
            ...
            }, ios_backgroundColor: trackDefaultColor !== null && trackDefaultColor !== void 0 ? trackDefaultColor : color.black, thumbColor: thumbColor !== null && thumbColor !== void 0 ? thumbColor : '#f4f3f4', onValueChange: (value) => setActive(value), value: active })));
};
