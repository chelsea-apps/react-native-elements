...
const Input = ({ name, control, error, errorTestID, errorColor, errorStyle, label, validation, onSubmitEditing, defaultValue, infoText, infoTextStyle, infoTextColor, infoTextTestID, icon, style, textEntryStyle, textEntryContainerStyle, labelStyle, bgColor, textColor, borderColor, focusedBorderColor, labelColor, selectionColor, testID, textEntryTestID, labelTestID, ...props }) => {
    return (React.createElement(View, { style: [t.mB4, style], testID: testID },
        ...
        , { 
            ...
            // Styling
            textEntryStyle: textEntryStyle, textEntryContainerStyle: textEntryContainerStyle, labelStyle: labelStyle, bgColor: bgColor !== null && bgColor !== void 0 ? bgColor : color.transparent, textColor: textColor !== null && textColor !== void 0 ? textColor : color.white, borderColor: borderColor !== null && borderColor !== void 0 ? borderColor : color.yellow400, focusedBorderColor: focusedBorderColor !== null && focusedBorderColor !== void 0 ? focusedBorderColor : color.yellow400, selectionColor: selectionColor !== null && selectionColor !== void 0 ? selectionColor : color.white, labelColor: labelColor !== null && labelColor !== void 0 ? labelColor : color.gray400, textEntryTestID: textEntryTestID, labelTestID: labelTestID, ...props }),
