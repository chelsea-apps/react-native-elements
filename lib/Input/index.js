...
const Input = ({ name, control, error, errorTestID, errorColor, errorStyle, label, validation, onSubmitEditing, defaultValue, infoText, infoTextStyle, infoTextColor, infoTextTestID, prefix, prefixStyle, postfix, postfixStyle, icon, style, textEntryStyle, textEntryContainerStyle, labelStyle, labelTopPosition, labelSmallFontSize, labelBigFontSize, bgColor, textColor, borderColor, focusedBorderColor, labelColor, focusedLabelColor, selectionColor, testID, textEntryTestID, labelTestID, ...props }) => {
    return (React.createElement(View, { style: [t.mB4, style], testID: testID },
        React.createElement(ControlledTextEntry
        // Functionality
        , { 
            // Functionality
            name: name, control: control, validation: validation, defaultValue: defaultValue, label: label, onSubmitEditing: onSubmitEditing, icon: icon, prefix: prefix, postfix: postfix, 
            // Styling
